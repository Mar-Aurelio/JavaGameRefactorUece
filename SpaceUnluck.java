...
public class SpaceUnluck extends Space {
  ...
  public void applyEffect(ArrayList<Player> players, int playersSize, int currentPlayer) {
    if (!(players.get(currentPlayer) instanceof PlayerLucky)) {
      ...
      System.out.println("Casa de azar: o jogador " + players.get(currentPlayer).getCor() + " perdeu 3 moedas");
    } else {
      System.out.println("Casa de azar: o jogador " + players.get(currentPlayer).getCor() + " não perdeu moedas por ser sortudo");
    }
  }
}
